...
CLIPS_DIR=video_0313  #path to the directory with mp4 videos
FRAMES_DIR=video_0313_image  #path to the directory for frames
...
ffmpeg -i $file -start_number 0 -f image2 -qscale 0 -vf fps=20/1 ${FRAMES_DIR}/$fname/%05d.png
